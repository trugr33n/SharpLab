...
namespace OOPproject.Model
{
    public class Item
    {
        ...
        public string Name { 
            ...
            set { ValueValidator.AssertStringOnLength(value, 201, nameof(Name)); this._name = value; }
        }

        public string Info { 
            get { return this._info; }
            set { ValueValidator.AssertStringOnLength(value, 1001, nameof(Info)); this._info = value; }
        }
